...
function ProyectosComponentes() {
  return (
    ...
    <section key={proyecto.id} className="bg-[#0B3F55] relative bg-opacity-30 p-2 flex flex-col justify-between  gap-2 transition-transform transform hover:-translate-y-1 lg:hover:-translate-y-2">
